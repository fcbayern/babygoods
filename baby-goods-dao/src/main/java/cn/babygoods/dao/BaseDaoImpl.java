...
public abstract class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    protected DalTableDao<T> client;

    public BaseDaoImpl(Class<T> typeParameterClass) throws SQLException {
        this.typeParameterClass = typeParameterClass;
        this.client = new DalTableDao<>(new DalDefaultJpaParser<>(typeParameterClass));
    }
